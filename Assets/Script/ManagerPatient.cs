...
public class ManagerPatient
{
    ...
    public Patient getPatientById(int id)
    {
        ...
        using (this.dbConnection)
        {
            ...
            {
				string sqlQuery = string.Format("Select IdP, NomP,PrenomP, DateNaisP, SexeP,NumTelP, IdMedecin, imageP from  Patient where IdP =" + id);
    ...
    public List<Patient> getPatientByMedecin(int idM)
    {
        ...
        using (this.dbConnection)
        {
            ...
            using (IDbCommand dbCmd = this.dbConnection.CreateCommand())
            {
				string sqlQuery = string.Format("Select IdP, NomP,PrenomP, DateNaisP, SexeP,NumTelP, IdMedecin, imageP from  Patient where IdMedecin =" + idM);
    ...
    public List<Patient> getAllPatient()
    {
        ...
        using (this.dbConnection)
        {
            ...
            using (IDbCommand dbCmd = this.dbConnection.CreateCommand())
            {
                string sqlQuery = string.Format("Select IdP, NomP,PrenomP, DateNaisP, SexeP,NumTelP, IdMedecin, imageP from  Patient ");
